 ...
 * the status from the POST request
...
class Connect2PayClient {
  ...
  public function preparePayment() {
    if ($this->validate()) {
      ...
      // echo "this is preparePayment if validate \n";
    } else {
  ...
  private function validateFields() {
    ...
    //   if (!C2PValidate::isEmpty($this->{$field}) && !call_user_func(array('C2PValidate', $method), $this->{$field}))
